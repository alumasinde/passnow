<section class="page-header"><div><span class="eyebrow">Administration</span><h1>ID types</h1><p>Tenant-configurable records returned by the backend.</p></div><a class="btn btn-primary" href="<?=e(url('id-types-edit.php'))?>"><i class="fa-solid fa-plus"></i> Add</a></section>
