...
if(requestMethod()==='POST'){
 ...
 if(!$errors)try{
  if($id){ConfigCrud::update('/api/v1/visitor-companies/'.$id,$payload);flash('success','Updated successfully.');}
  else{ConfigCrud::create('/api/v1/visitor-companies',$payload);flash('success','Created successfully.');}
