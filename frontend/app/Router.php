...
final class Router
{
    ...
    private array $routes = [
        ...
        '/gatepasses'=>'Gatepasses/Index.php','/gatepasses.php'=>'Gatepasses/Index.php','/gatepass.php'=>'Gatepasses/Show.php','/gatepass-create.php'=>'Gatepasses/Create.php','/gatepass-operation.php'=>'Gatepasses/Operation.php','/gatepass-cancel.php'=>'Gatepasses/Cancel.php','/gate-operations.php'=>'Gatepasses/Operations.php','/gatepass-qr.php'=>'Gatepasses/Qr.php','/gatepass-settings.php'=>'Gatepasses/Settings.php','/gatepass-types.php'=>'Gatepasses/Types.php','/gatepass-types-edit.php'=>'Gatepasses/TypeEdit.php',
        ...
        '/settings'=>'Settings/Index.php','/settings.php'=>'Settings/Index.php','/theme-settings.php'=>'Settings/Theme.php','/theme-settings'=>'Settings/Theme.php','/media'=>'Settings/Media.php','/media.php'=>'Settings/Media.php',
