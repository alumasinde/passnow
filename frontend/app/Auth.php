...
final class Auth {
 ...
 public static function requireLogin():void{if(!self::check())redirect('login.php');} public static function requirePlatform():void{if(!self::platformCheck())redirect('platform-login.php');}
