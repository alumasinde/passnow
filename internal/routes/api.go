...
func RegisterAPI(mux *http.ServeMux, api *API) {
	...
	mux.Handle("PATCH /api/v1/roles/{id}", protected("role.read", api.RoleHandler.UpdateRole))
	mux.Handle("POST /api/v1/roles", protected("role.read", api.RoleHandler.CreateRole))
