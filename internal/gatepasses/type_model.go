...
func TypeToDTO(t *GatepassType) TypeDTO {
	return TypeDTO{ID:t.ID,Name:t.Name,Code:t.Code,Description:t.Description,Direction:string(t.Direction),GateAssignmentRequired:t.GateAssignmentRequired,AllowedGateIDs:t.AllowedGateIDs,IsReturnableDefault:t.IsReturnableDefault,ReturnabilityPolicy:string(t.ReturnabilityPolicy),RequiresItems:t.RequiresItems,RequiresApproval:t.RequiresApproval,WorkflowID:t.WorkflowID,Active:t.Active}
}
